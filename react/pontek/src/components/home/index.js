    ...
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <a href="#/autoflirt" 
                        onMouseEnter={() => setTimeout(() => this.setState({flirt: 'Generated by Autoflirt. Click to see more!'}), 300)} 
                        onMouseLeave={() => this.setState({flirt: generate()})}
                        className="offset-md-2 col-md-8 flirt text-center"
                        >
                        {this.state.flirt}
                    </a>
                </div>
