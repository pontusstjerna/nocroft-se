...
import Escape from '../pages/escape.js'
      ...
      <Router history={history}>
        <div>
          <div className="o-header">
            <button className="o-header__trigger" onClick={this.toggleMenu}>
              <span></span>
            </button>
            <a
              className="o-header__item"
              href="/"
              onClick={() => this.scrollTo('section-home')}
            >
              Home
            </a>
            {isLoggedIn && (
              <a className="o-header__item" href="/matilda">
                Matildas test
              </a>
            )}
            {isLoggedIn && (
