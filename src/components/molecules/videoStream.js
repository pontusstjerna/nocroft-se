...
class VideoStream extends Component {
    ...
    constructor(props) {
        ...
        this.videoURL = `wss://${window.location.host.split(':')[0]}/${props.url}`
    ...
    componentDidMount() {
        ...
        fetch(`${API_URL}/access-token`, {
            ...
            const videoPlayer = this.connectVideoCanvas(document.getElementById(this.canvasIdentifier), this.videoURL + '?access_token=' + videoToken, token, this.onError);
